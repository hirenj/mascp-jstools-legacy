...
if(object.type=="marker"){var content=(object.options||{}).content;if(Array.isArray&&Array.isArray(content)){click_reveal=renderer.getAA(parseInt(object.aa)).addToLayer(track,object.options);click_reveal=click_reveal[1];click_reveal.style.display='none';object.options.content=object.options.alt_content;}else if(typeof(content)=='object'){var content_el;if(content.type=="circle"){content_el=renderer._canvas.circle(-0.5,-0.5,1,1);}
