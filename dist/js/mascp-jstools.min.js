...
return;}
auth_settings.immediate=false;gapi.auth.authorize(auth_settings,arguments.callee);return;}}});},1);return;};do_request=function(host,path,etag,callback,method,data){authenticate(function(err){if(err){callback.call(null,err);return;}
...
callback=null;}else{if(callback!==null){callback.call(null,{'cause':{'status':request.status}});}
