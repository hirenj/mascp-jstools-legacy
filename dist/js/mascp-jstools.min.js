...
var query=encodeURIComponent("title='"+prefs_domain+"' and mimeType = 'application/json; data-type=domaintool-session' and trashed = false");do_request("www.googleapis.com","/drive/v2/files?q="+query,null,function(err,data){if(err){callback.call(null,err);return;}
...
var query=encodeURIComponent("title='"+prefs_domain+"' and mimeType = 'application/json; data-type=domaintool-session' and trashed = false");do_request("www.googleapis.com","/drive/v2/files?q="+query,null,function(err,data){if(err){callback.call(null,err);return;}
var item_id=null;if(data.items&&data.items.length==0){do_request("www.googleapis.com","/drive/v2/files/",null,arguments.callee,"POST:application/json",JSON.stringify({"title":prefs_domain,"mimeType":"application/json; data-type=domaintool-session","description":"Domaintool session information for session "+prefs_domain}));return;}
