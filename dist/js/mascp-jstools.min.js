...
a_temp_reader.retrieve(entry,function(){get_data(this.result._raw_data.etag);});});})();return reader;};})();if(typeof MASCP=='undefined'||typeof MASCP.Service=='undefined'){throw"MASCP.Service is not defined, required class";}
