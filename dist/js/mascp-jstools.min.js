...
var old_get_aas=widget_rend.getAminoAcidsByPosition;var old_get_pep=widget_rend.getAminoAcidsByPeptide;widget_rend.getAminoAcidsByPosition=function(aas){var new_aas=aas.map(function(aa){return Math.abs(self.result.calculatePositionForSequence(index,aa));});return old_get_aas.call(this,new_aas);};widget_rend.getAminoAcidsByPeptide=function(){};old.call(reader);widget_rend.getAminoAcidsByPosition=old_get_aas;widget_rend.getAminoAcidsByPeptide=old_get_pep;}});}
