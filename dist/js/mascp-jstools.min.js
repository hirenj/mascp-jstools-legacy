...
var store=idb.createObjectStore("cached",{keyPath:"id"});store.createIndex("entries",["acc","service"],{unique:false});store.createIndex("timestamps",["service","retrieved"],{unique:false});store.createIndex("services","service",{unique:false});}}
