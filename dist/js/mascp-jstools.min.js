...
var item_id=data.items[0].id;do_request("www.googleapis.com","/drive/v2/files/"+item_id,null,function(err,data){if(err){callback.call(null,err);return;}
var uri=parseUri(data.downloadUrl);do_request(uri.host,uri.relative,null,function(err,data){if(err){callback.call(null,err);return;}
if(!data){data={};}
