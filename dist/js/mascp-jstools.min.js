...
var req=gapi.client.request({'path':"/upload/drive/v2/files/"+item_id,'method':"PUT",'params':{"uploadType":"media"},'headers':{'Content-Type':mime},'body':JSON.stringify(cached_files[filename])});req.execute(function(isjson,data){if(!isjson){callback.call(null,{"status":"Google error","response":response});return;}
