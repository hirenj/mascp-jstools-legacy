...
var old=reader.gotResult;reader.gotResult=function(){var index=0;var wanted_id=reader.acc||reader.agi||"";var curr_sequence=renderer.sequence;for(var i=0;i<self.sequences.length;i++){if(self.sequences[i].agi&&self.sequences[i].agi.toUpperCase()==wanted_id.toUpperCase()){renderer.sequence=self.sequences[i].toString();index=i;}}
