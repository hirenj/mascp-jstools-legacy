...
get_document_using_script(doc_id,callback);}else{callback.call(null,null,dat);}});}else{get_document_using_script(doc_id,function(err,dat){if(err){basic_get_document(doc,etag,function(err,dat){if(err){if(err.cause=="No user event"||err.cause=="Access is denied."){callback.call(null,err);return;}
get_document_using_script(doc_id,callback);}else{callback.call(null,null,dat);}});}else{callback.call(null,null,dat);}});}};}
