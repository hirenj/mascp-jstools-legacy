...
renderer.zoom=1;renderer.refresh();};this.bind('resultReceived',function(){var result=this.result;redraw_alignments(0);var accs=[];self.sequences.forEach(function(seq){accs.push(seq.agi);});renderer.bind('orderChanged',function(e,order){redraw_alignments(accs.indexOf(order[(order.indexOf(controller_name)+1)]));});});}
