...
db.exec("BEGIN TRANSACTION;",function(err){if(err){callback.call(null,err);return;}
...
db.exec("END TRANSACTION;",function(err){get_db_data=old_get_db_data;old_get_db_data=null;callback(err);});};}else{begin_transaction=function(callback,trans){callback.call({"transaction":trans});};end_transaction=function(callback){callback();};}
