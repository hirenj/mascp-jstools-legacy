...
var req=gapi.client.request({'path':"/upload/drive/v2/files/"+item_id,'method':"PUT",'params':{"uploadType":"media"},'headers':{'Content-Type':'application/json; data-type=domaintool-session'},'body':JSON.stringify(MASCP.preferences[prefs_domain])});req.execute(function(err,data){if(err){callback.call(null,err);return;}
...
var dataset={};if(typeof this.map=='object'){dataset=apply_map.call(this,data);}
