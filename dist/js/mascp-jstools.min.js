...
return get_file(prefs_domain,"application/json; data-type=domaintool-session",callback);};MASCP.GoogledataReader.prototype.writePreferences=function(prefs_domain,callback){return write_file(prefs_domain,"application/json; data-type=domaintool-session",callback);};MASCP.GoogledataReader.prototype.createPreferences=function(folder,callback){return create_file({"parent":folder,"content":{},"name":"New annotation session"},"application/json; data-type=domaintool-session",function(err,content,file_id){callback.call(null,err,content,file_id,"New annotation session");});};MASCP.GoogledataReader.prototype.getSyncableFile=function(file,callback){var file_block={"getData":function(){return"Not ready";},"ready":false};get_file(file,"application/json",function(err,filedata,file_id){if(err){callback.call(null,err);}
