...
if(object.type=="marker"){var content=(object.options||{}).content;var wanted_height=object.options.height;if(Array.isArray&&Array.isArray(content)){click_reveal=renderer.getAA(parseInt(object.aa)).addToLayer(track,JSON.parse(JSON.stringify(object.options)));click_reveal=click_reveal[1];click_reveal.style.display='none';object.options.content=object.options.alt_content;}else if(typeof(content)=='object'){var content_el;if(content.type=="circle"){content_el=renderer._canvas.circle(-0.5,-0.5,1,1);}
...
var added=renderer.getAA(parseInt(object.aa)).addToLayer(track,JSON.parse(JSON.stringify(object.options)));if(click_reveal){added[1].addEventListener('click',function(){if(click_reveal.style.display==='none'){click_reveal.parentNode.appendChild(click_reveal);click_reveal.style.display='block';}else{click_reveal.style.display='none';}
