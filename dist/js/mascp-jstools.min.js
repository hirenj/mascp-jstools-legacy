...
data.items.forEach(function(item){if(item.id==permissionId&&(item.role=='owner'||item.role=='writer')){writable=true;}});callback.call(null,null,{"write":writable,"read":true});});});};get_document=function(doc,etag,callback){var is_spreadsheet=true;if(!doc.match(/^spreadsheet/)){is_spreadsheet=false;}
