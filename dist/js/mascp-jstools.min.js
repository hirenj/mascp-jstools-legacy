...
if(pref.type=="liveClass"){var reader_class=MASCP[set];callback.call(null,null,pref,new reader_class());return;}
...
var old=reader.gotResult;reader.gotResult=function(){var index=0;for(var i=0;i<self.sequences.length;i++){if(self.sequences[i].agi&&self.sequences[i].agi.toUpperCase()==reader.agi){index=i;}}
...
console.log(objects);objects.forEach(function(object){var click_reveal;var rendered;if(object.type==="box"){if(object.aa){rendered=renderer.getAA(parseInt(object.aa)).addBoxOverlay(track,parseInt(object.width),1,object.options);}else if(object.peptide){rendered=renderer.getAminoAcidsByPeptide(object.peptide).addToLayer(track,object.options);}}
