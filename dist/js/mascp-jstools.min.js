...
return;};var parsedata=function(data){var entryidRC=/.*\/R(\d*)C(\d*)/;var retdata={};retdata.data=[];var max_rows=0;for(var l in data.feed.entry)
...
var get_document,get_document_list;if(typeof module!='undefined'&&module.exports){get_document_list=function(callback){var headers_block={'GData-Version':'3.0'};if(MASCP.GOOGLE_AUTH_TOKEN){headers_block['Authorization']='Bearer '+MASCP.GOOGLE_AUTH_TOKEN;}else{callback.call(null,"Not authorized");return;}
...
var doc_id=doc.replace(/^spreadsheet:/,'');var headers_block={'GData-Version':'3.0'};var feed_type='public';if(MASCP.GOOGLE_AUTH_TOKEN){headers_block['Authorization']='Bearer '+MASCP.GOOGLE_AUTH_TOKEN;feed_type='private';}
