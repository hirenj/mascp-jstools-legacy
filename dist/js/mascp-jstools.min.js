...
var uri=parseUri(data.downloadUrl);file.etag=data.etag;file.modified=new Date(data.modifiedDate);do_request(uri.host,uri.relative,null,function(err,data){if(err){callback.call(null,err);return;}
if(!data){data={};}
