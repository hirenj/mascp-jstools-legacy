...
var old=reader.gotResult;reader.gotResult=function(){var index=0;var wanted_id=reader.acc||reader.agi||"";for(var i=0;i<self.sequences.length;i++){if(self.sequences[i].agi&&self.sequences[i].agi.toUpperCase()==wanted_id.toUpperCase()){index=i;}}
