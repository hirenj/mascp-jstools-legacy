...
scrollContainer.style.overflowX='scroll';scrollContainer.style.overflowY='hidden';scroller.style.position='absolute';scroller.style.left='0px';scroller.style.width='100%';scroller.style.height='100%';bean.remove(scrollContainer,'scroll');bean.remove(scrollContainer,'mouseenter');bean.add(scrollContainer,'mouseenter',function(){scrollContainer.scrollLeft+=1;scrollContainer.scrollLeft-=1;});if(window.matchMedia&&!GOMap.print_watcher){window.matchMedia('print').addListener(function(matcher){GOMap.in_print=!matcher.matches;});GOMap.print_watcher=true;}
bean.add(scrollContainer,'scroll',function(){if(GOMap.print_watcher&&GOMap.in_print){return;}
