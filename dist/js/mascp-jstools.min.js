...
objects.forEach(function(object){var click_reveal;var rendered;if(object.aa!==null&&(isNaN(object.aa)||!renderer.getAA(parseInt(object.aa)))){return;}
if(object.type==="box"){if(object.aa){rendered=renderer.getAA(parseInt(object.aa)).addBoxOverlay(track,parseInt(object.width),1,object.options);}else if(object.peptide){rendered=renderer.getAminoAcidsByPeptide(object.peptide).addToLayer(track,object.options);}}
