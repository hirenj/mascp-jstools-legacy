...
var doc_id=doc.replace(/^spreadsheet:/,'');get_document_using_script(doc_id,function(err,dat){if(err){console.log("Retrying with authentication");basic_get_document(doc,etag,callback);}else{callback.call(null,null,dat);}});};}
