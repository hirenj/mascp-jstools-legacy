...
if(MASCP.GOOGLE_AUTH_TOKEN){headers_block['Authorization']='Bearer '+MASCP.GOOGLE_AUTH_TOKEN;}else{var self_func=arguments.callee;authenticate(function(err){if(!err){self_func.call(null,host,path,etag,callback);}else{self_func.call(err);}});return;}
