...
request.send(datablock);};MASCP.Service.request=function(url,callback){var method=MASCP.IE?do_request_ie:do_request;var params={async:true,url:url,timeout:5000,type:"GET",error:function(response,req,status){callback.call(null,{"status":status});},success:function(data,status,xhr){callback.call(null,null,data);}};method.call(null,params);};var do_request_ie=function(dataHash)
